...
// AYAchemy Pose Stand (viewer-local) motion IDs
LLUUID const ANIM_AYA_POSE_T_POSE                         ("11111111-1111-1111-1111-111111111111");
LLUUID const ANIM_AYA_POSE_ARMS_DOWN_LEGS_TOGETHER        ("11111111-1111-1111-1111-111111111112");
LLUUID const ANIM_AYA_POSE_ARMS_DOWNWARD_LEGS_APART       ("11111111-1111-1111-1111-111111111113");
LLUUID const ANIM_AYA_POSE_ARMS_DOWNWARD_LEGS_TOGETHER    ("11111111-1111-1111-1111-111111111114");
LLUUID const ANIM_AYA_POSE_ARMS_FORWARD_LEGS_APART        ("11111111-1111-1111-1111-111111111115");
LLUUID const ANIM_AYA_POSE_ARMS_FORWARD_LEGS_TOGETHER     ("11111111-1111-1111-1111-111111111116");
LLUUID const ANIM_AYA_POSE_ARMS_STRAIGHT_LEGS_APART       ("11111111-1111-1111-1111-111111111117");
LLUUID const ANIM_AYA_POSE_ARMS_UPWARD_LEGS_APART         ("11111111-1111-1111-1111-111111111118");
LLUUID const ANIM_AYA_POSE_ARMS_UPWARD_LEGS_TOGETHER      ("11111111-1111-1111-1111-111111111119");
