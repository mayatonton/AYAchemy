...
extern const LLUUID ANIM_AYA_POSE_T_POSE;
extern const LLUUID ANIM_AYA_POSE_ARMS_DOWN_LEGS_TOGETHER;
extern const LLUUID ANIM_AYA_POSE_ARMS_DOWNWARD_LEGS_APART;
extern const LLUUID ANIM_AYA_POSE_ARMS_DOWNWARD_LEGS_TOGETHER;
extern const LLUUID ANIM_AYA_POSE_ARMS_FORWARD_LEGS_APART;
extern const LLUUID ANIM_AYA_POSE_ARMS_FORWARD_LEGS_TOGETHER;
extern const LLUUID ANIM_AYA_POSE_ARMS_STRAIGHT_LEGS_APART;
extern const LLUUID ANIM_AYA_POSE_ARMS_UPWARD_LEGS_APART;
extern const LLUUID ANIM_AYA_POSE_ARMS_UPWARD_LEGS_TOGETHER;
